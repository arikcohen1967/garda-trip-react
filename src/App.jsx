...
// מאגר ענק ומקיף של למעלה מ-300 שאלות טריויה לגילאי עד 16
const ROAD_TRIVIA_QUESTIONS = [
  // 1-50: איטליה, גארדה וונציה
  { q: "איזה נהר זורם לאורך אגם גארדה ויוצר את העיירות הציוריות סביבו?", options: ["נהר הפּוֹ", "נהר המינצ׳ו", "נהר הטיבר", "נהר הארנו"], correct: 1 },
  { q: "כמה גשרים רגילים יש בעיר ונציה?", options: ["אפס – יש רק מעבורות", "יותר מ-400 גשרים", "כ-50 גשרים בלבד", "כמעט אלף גשרים"], correct: 1 },
  { q: "מהו מאכל הפסטה המפורסם ביותר שמקורו בעיירה בורגטו (Borghetto)?", options: ["ספגטי קרבונרה", "טורטליני 'קשר האהבה'", "לזניה בשרית", "רביולי גבינות"], correct: 1 },
  { q: "באיזו שנה נפתח פארק השעשועים גארדלנד (Gardaland)?", options: ["1955", "1975", "1990", "2005"], correct: 1 },
  { q: "איזה הר געש מפורסם נמצא בדרום איטליה ליד נאפולי?", options: ["הר הפוג'י", "הר וזוב", "אטנה", "סטרומבולי"], correct: 1 },
  ...
  { q: "באיזו עיר באיטליה מתרחשת עלילת 'רומיאו ויוליה'?", options: ["מילאנו", "רומא", "ורונה", "פלורנס"], correct: 2 },
  { q: "מהו פירוש המילה 'צ'או' (Ciao) באיטלקית במקור?", options: ["להתראות לנצח", "העבד שלך / לרשותך", "בוקר טוב אדוני", "שלום חבר יקר"], correct: 1 },
  { q: "מהי בירת איטליה?", options: ["מילאנו", "ונציה", "רומא", "נאפולי"], correct: 2 },
  { q: "איזה צבעים יש בדגל איטליה?", options: ["אדום, לבן וכחול", "ירוק, לבן ואדום", "כחול, צהוב ואדום", "ירוק, צהוב ואדום"], correct: 1 },
  { q: "איזה מגדל מפורסם באיטליה ידוע בכך שהוא עקום?", options: ["המגדל של מילאנו", "המגדל של פיזה", "המגדל של ונציה", "המגדל של רומא"], correct: 1 },
  { q: "איזה מהמאכלים הבאים הומצא במקור באיטליה?", options: ["סושי", "פיצה מרגריטה", "הירושימי", "בוריטו"], correct: 1 },
  { q: "מהי המדינה הקטנה ביותר בעולם שנמצאת כולה בתוך העיר רומא?", options: ["מונקו", "סן מרינו", "ותיקן", "ליכטנשטיין"], correct: 2 },
  { q: "באיזו ים נמצאת איטליה?", options: ["הים הפסיפי", "הים התיכון", "הים הבלטי", "הים האדום"], correct: 1 },
  { q: "מה שמו של הר הגעש הפעיל הגדול באירופה שנמצא באי סיציליה?", options: ["וזוב", "אטנה", "סטרומבולי", "קרקטואה"], correct: 1 },
  { q: "איזה חומר גלם עיקרי יש בגלידה איטלקית מסורתית (ג'לאטו)?", options: ["שמן זית", "חלב טרי", "מים בלבד", "ביצים קשות"], correct: 1 },
  { q: "איזה פארק מים ושעשועים באיטליה מבוסס כולו על סרטי הוליווד ופעלולים?", options: ["גארדלנד", "מובילנד (Movieland)", "מיראביליה", "דיסקלנד"], correct: 1 },
  { q: "איזה אגם באיטליה הוא הגדול ביותר במדינה?", options: ["אגם קומו", "אגם מאג'ורה", "אגם גארדה", "אגם טראזימנו"], correct: 2 },
  { q: "מהי צורת המגף המפורסמת של איטליה?", options: ["נעל ספורט", "מגף גבוה", "כפכף", "מגפיים של עובדי בניין"], correct: 1 },
  { q: "איזה איטלקי גילה את אמריקה בשנת 1492?", options: ["מרקו פולו", "כריסטופר קולומבוס", "לאונרדו דה וינצ'י", "גלילאו גליליי"], correct: 1 },
  { q: "מי צייר את היצירה המפורסמת 'המונה ליזה'?", options: ["מיכלאנג'לו", "לאונרדו דה וינצ'י", "רפאל", "דונטלו"], correct: 1 },
  { q: "מה שמה של העיר המפורסמת שבה במקום מכוניות יש תעלות מים וגונדולות?", options: ["נאפולי", "ונציה", "פלורנס", "בולוניה"], correct: 1 },
  { q: "איזה משקה קפה איטלקי מורכב מאספרסו וחלב מוקצף?", options: ["אמריקנו", "קפוצ'ינו", "מקיאטו", "שחור"], correct: 1 },
  { q: "איזה איטלקי המציא את הסוללה החשמלית הראשונה?", options: ["אלסנדרו וולטה", "אנטוניו מיוצי", "גלילאו", "מרקוני"], correct: 0 },
  { q: "מה פירוש המילה 'ג'לאטו' (Gelato)?", options: ["עוגה", "גלידה", "שוקולד", "סוכרייה"], correct: 1 },
  { q: "באיזו עיר נמצאת הארנה העתיקה שבה נערכים מופעים וקרבות גלדיאטורים לשעבר?", options: ["מילאנו", "ורונה", "ונציה", "טורינו"], correct: 1 },
  { q: "איזה רכב ספורט אדום ומפורסם מיוצר באיטליה?", options: ["פורשה", "פרארי", "ב.מ.וו", "טסלה"], correct: 1 },
  { q: "איזה פירות ים הכי נפוצים בפיצות ומאכלים בוונציה?", options: ["שרימפס וקלמרי", "סרטנים מתוקים", "דגי זהב", "לובסטרים ענקיים"], correct: 0 },
  { q: "מהו ההר הגבוה ביותר באירופה שנמצא בחלקו באיטליה?", options: ["הר האוורסט", "הר מון בלאן", "האלפים הצרפתיים", "הר דולומיטים"], correct: 1 },
  { q: "איזה מהמאכלים הבאים מוגש חם עם שוקולד או נוטלה באיטליה?", options: ["קנולי / סופגניות איטלקיות", "סושי", "סלט יווני", "מרק בצל"], correct: 0 },
  { q: "באיזו עיר איטלקית נמצא מגדל פיזה העקום?", options: ["רומא", "פיזה", "מילאנו", "פלורנץ"], correct: 1 },
  { q: "מה שמו של נמל התעופה הראשי שליד אגם גארדה שבו נוחתים בדרך כלל?", options: ["שדה התעופה של ורונה", "שדה התעופה של רומא", "שדה התעופה של מילאנו", "שדה התעופה של ונציה"], correct: 0 },
  { q: "איזו עיירה באגם גארדה ידועה במטעי הלימונים שלה ובצוקים המדהימים שמעליה?", options: ["לימונה סול גארדה", "פסקיירה", "לזצ'ה", "סירמיונה"], correct: 0 },
  { q: "מהו שמה של הטירה העתיקה והמפורסמת הבנויה ממש בתוך המים בדרום אגם גארדה?", options: ["טירת סקליג'רו בסירמיונה", "טירת ורונה", "טירת ונציה", "ארמון הדוצ'ה"], correct: 0 },
  { q: "איזה סוג פסטה דק וארוך נחשב לפופולרי ביותר בעולם?", options: ["ספגטי", "פנה", "פוזילי", "רביולי"], correct: 0 },
  { q: "מה שמה של העיר העתיקה והרומנטית ביותר שיושבת על לגונה עם תעלות?", options: ["ונציה", "מילאנו", "נאפולי", "ג'נובה"], correct: 0 },
  { q: "איזו גלידה איטלקית מפורסמת משלבת שוקולד צ'יפס ושברי שקדים?", options: ["צ'יאצ'יאטלה / שטרצ'יאטלה", "וניל רגיל", "תות שדה", "מנגו"], correct: 0 },
  { q: "איזה ספורט ימי חווייתי עושים בדרך כלל על נהר האדיג'ה ליד גארדה?", options: ["ראפטינג", "סקי מים", "גלישת רוח", "צלילה עמוקה"], correct: 0 },
  { q: "מהו שמם של כיסוני הבצק הממולאים בבשר או גבינה באיטליה?", options: ["טורטליני או רביולי", "ספגטי", "ניוקי", "קנלוני"], correct: 0 },
  { q: "איזה קינוח איטלקי עשוי מגבינת מסקרפונה, בישקוטים, קפה ואבקת קקאו?", options: ["טימישוארה", "טימיס", "טימיסמי", "טימיסו / טירימיסו (Tiramisu)"], correct: 3 },

  // 51-150: מדע, טבע, חלל ובעלי חיים
  { q: "כמה רגליים יש לעכביש?", options: ["6", "8", "10", "12"], correct: 1 },
  { q: "מהי המדינה הגדולה בעולם מבחינת שטח?", options: ["ארצות הברית", "סין", "קנדה", "רוסיה"], correct: 3 },
  ...
  // 151-320: סרטים, תרבות פופולרית, גיימינג, גאוגרפיה וחידות חשיבה
  ...
  { q: "מהו משחק קלפים הכולל קלפים בצבעים וקלפי הפתעה כמו פלוס 4?", options: ["טאקי / אונו", "פוקר", "רמי", "סוליטר"], correct: 0 },

...
// מאגר ענק של מעל 300 שאלות טריויה מותאמות לגילאי עד 16 (איטליה, גאוגרפיה, מדע, סרטים וכללי)
const ROAD_TRIVIA_QUESTIONS = [
  { q: "איזה נהר זורם לאורך אגם גארדה ויוצר את העיירות סביבו?", options: ["נהר הפּוֹ", "נהר המינצ׳ו", "נהר הטיבר", "נהר הארנו"], correct: 1 },
  ...
  { q: "איזה חג שבו אוכלים המון אוזני המן חוגגים ביהדות?", options: ["פסח", "פורים", "חנוכה", "סוכות"], correct: 1 },
  ...
  { q: "מהי היבשה הקטנה ביותר בעולם?", options: ["אפריקה", "אוסטרליה", "אירופה",נוספת], correct: 1 },
  { q: "באיזו מדינה נמצא המפלים הגבוהים בעולם (מפלי אנג'ל)?", options: ["ונצואלה", "ברזיל", "ארצות הברית", "קנדה"], correct: 0 },
  { q: "כמה שיניים יש לבן אדם מבוגר בדרך כלל (כולל בינה)?", options: ["28", "32", "36", "24"], correct: 1 },
  { q: "איזה חומר קשה ביותר בטבע?", options: ["ברזל", "זהב", "יהלום", "טיטניום"], correct: 2 },
  ...
  { q: "איזה בעל חיים הוא הגדול ביותר בעולם כיום (אפילו יותר מדינוזאורים)?", options: ["פיל אפריקאי", "לווייתן כחול", "תנין הים", "ג'ירפה"], correct: 1 },
  ...
  { q: "איזה חג יהודי מכונה 'חג האורים'?", options: ["פסח", "פורים", "חנוכה", "שבועות"], correct: 2 },
  { q: "מהו שמו של המדען המפורסם שניסח את תורת היחסות (E=mc^2)?", options: ["אייזק ניוטון", "אלברט איינשטיין", "ניקולาส טסלה", "סטיבן הוקינג"], correct: 1 },
  ...
  { q: "מהו שמו של הכלב המפורסם בסדרת הקומיקס 'סנופי'?", options: ["סנופי", "פלטו", "לאסי", "בנצי"], correct: 0 },
  { q: "כמה רגליים יש לחרקים?", options: ["4", "6", "8", "10"], correct: 1 },
  { q: "איזה כלי נגינה יש לנגן עליו באמצעות הקשה במקלות?", options: ["גיטרה", "חליל", "תופים", "כינור"], correct: 2 },
  ...
  { q: "מהו שמו של גיבור העל שנושך על ידי עכביש רדיואקטיבי?", options: ["באטמן", "ספיידרמן", "סופרמן", "איירון מן"], correct: 1 },
  { q: "איזה מהרכבים הבאים פועל על חשמל בלבד?", options: ["רכב בנזין קלאסי", "רכב טסלה", "משאית דיזל", "אופנוע ים"], correct: 1 },
  { q: "באיזו עיר נמצא פסל החירות?", options: ["לוס אנג'לס", "ניו יורק", "שיקגו", "מיאמי"], correct: 1 },
  { q: "איזה בעל חיים נחשב למלך החיות?", options: ["נמר", "אריה", "פיל", "זאב"], correct: 1 },
  { q: "כמה צבעים יש בקשת בענן?", options: ["5", "6", "7", "8"], correct: 2 },
  ...
  { q: "איזה חג מציין את יציאת בני ישראל ממצריים?", options: ["שבועות", "פסח", "סוכות", "פורים"], correct: 1 },
  { q: "איזה כלי תחבורה נוסע על מסילות ברזל?", options: ["מטוס", "רכבת", "אונייה", "אופניים"], correct: 1 },
  { q: "מהו הצבע שמקבלים כשמערבבים צהוב וכחול?", options: ["כתום", "סגול", "ירוק", "חום"], correct: 2 },
  { q: "איזה בעל חיים הוא הגבוה ביותר בעולם?", options: ["פיל", "ג'ירפה", "סוס", "דוב קוטב"], correct: 1 },
  { q: "איזה חרק מפורסם ידוע בנקודות השחורות שיש לו על כנפיים אדומות?", options: ["פרת משה רבנו", "חיפושית זבל", "דבורה", "יתוש"], correct: 0 },
  { q: "מהי השפה הרשמית המדוברת בישראל לצד ערבית?", options: ["אנגלית", "עברית", "צרפתית", "ספרדית"], correct: 1 },
  ...
  { q: "כמה שעות יש ביממה אחת?", options: ["12", "24", "48", "36"], correct: 1 },
  { q: "מה שמה של בובת הספוג הצהובה שגר באננס מתחת לים?", options: ["פטריק", "ספוגובב קבוע", "ספוגבוב מכנסמרובע", "סקווידוויד"], correct: 2 },
  { q: "איזה בעל חיים מייצר קול שנקרא 'מיאו'?", options: ["כלב", "חתול", "פרה", "סוס"], correct: 1 },
  { q: "איזה חומר משמש לייצור זכוכית בעיקר?", options: ["פלסטיק", "חול", "עץ", "חרס"], correct: 1 },
  { q: "מהו כוכב הלכת הגדול ביותר במערכת השמש?", options: ["שבתאי", "צדק (Jupiter)", "מאדים", "נפטון"], correct: 1 },
  { q: "איזה פרי נקרא באנגלית 'Apple'?", options: ["תפוז", "תפוח", "בננה", "אגס"], correct: 1 },
  { q: "באיזו מדינה נמצאת העיר טוקיו?", options: ["סין", "יפן", "קוריאה", "ויאטנם"], correct: 1 },
  { q: "מהו כלי הנגינה שיש לו קלידים שחורים ולבנים רבים?", options: ["גיטרה", "פסנתר", "חצוצרה", "תופים"], correct: 1 },
  { q: "איזה סרט אנימציה של דיסני מציג דגים שמחפשים את נמו?", options: ["למצוא את נמו", "מלך האריות", "בת הים הקטנה", "אלדין"], correct: 0 },
  { q: "כמה חודשים יש בשנה לועזית?", options: ["10", "12", "14", "6"], correct: 1 },
  ...
  { q: "מהו הלחם האמריקאי העגול שחותכים לשניים ושמים בתוכו קציצה?", options: ["פיתה", "לחמניית המבורגר", "בגט", "בייגל"], correct: 1 },
  ...
  { q: "באיזו מדינה נמצאת העיר הגדולה ניו יורק?", options: ["קנדה", "ארצות הברית", "בריטניה", "אוסטרליה"], correct: 1 },
  ...
  { q: "איזה ספורט משחקים עם כדור כתום וסל גבוה?", options: ["כדורגל", "כדורסל", "טניס", "בייסבול"], correct: 1 },
  { q: "מהו המאכל הלאומי של איטליה שכולם אוהבים?", options: ["סושי", "הבורגר", "פיצה", "פאייה"], correct: 2 },
  ...
  { q: "מה שמה של המדינה הגדולה ביותר במזרח התיכון מבחינת שטח?", options: ["ישראל", "סעודיה", "מצרים", "ירדן"], correct: 1 },
  ...
  { q: "איזה כלי נגינה מנגנים בו באמצעות נשיפה והוא עשוי ממתכת ארוכה ומפותלת?", options: ["חצוצרה", "פסנתר", "גיטרה", "כינור"], correct: 0 },
  { q: "מהו המאכל המרכזי שאוכלים בלג בעומר סביב המדורה?", options: ["פיצה", "מרשמלו ותפוחי אדמה", "סושי", "פסטה"], correct: 1 },
  { q: "איזה יבשת נחשבת לחמה ביותר וכוללת את מדבר סהרה?", options: ["אסיה", "אפריקה", "אוסטרליה", "אמריקה הדרומית"], correct: 1 },
  { q: "איזה משחק חברה משחקים עם לוח ובו רחובות כמו מלכי ישראל ודיזנגוף?", options: ["שחמט", "מונופול", "טאקי", "דמקה"], correct: 1 },
  ...
  { q: "מהו השם של משחק בניית הגשרים והבתים שבו שוברים עצים וגושי אדמה?", options: ["Minecraft", "Roblox", "Fortnite", "FIFA"], correct: 0 },
  ...
  { q: "איזה מאכל איטלקי מורכב מבצק שטוח עם רוטב עגבניות וגבינה שנמסה בתנור?", options: ["פסטה", "פיצה", "לזניה", "רביולי"], correct: 1 },
  { q: "כמה שחקנים יש בקבוצת כדורסל על המגרש לכל קבוצה?", options: ["5", "6", "7", "11"], correct: 0 },
  { q: "איזה כוכב לכת הוא הקרוב ביותר לשמש?", options: ["נוגה", "מרקורי", "מאדים", "כדור הארץ"], correct: 1 },
  ...
  { q: "מהו שמה של בירת איטליה שוב?", options: ["מילאנו", "רומא", "ונציה", "פלורנס"], correct: 1 },
  { q: "איזה חג יהודי חוגגים עם תחפושות ואוזני המן?", options: ["פסח", "פורים", "חנוכה", "שבועות"], correct: 1 },
  ...
  { q: "איזה ספורט כולל חבטות בכדור באמצעות מחט קטנה לתוך גומות באדמה?", options: ["טניס", "גולף", "בייסבול", "הוקי"], correct: 1 },
  ...
  { q: "מה שמה של העיר העתיקה והקדושה ביותר בישראל המרכזית?", options: ["תל אביב", "חיפה", "ירושלים", "באר שבע"], correct: 2 },
  { q: "איזה צבע מקבלים מערבוב של כחול וצהוב?", options: ["כתום", "ירוק", "סגול", "חום"], correct: 1 },
  { q: "מהו המאכל המרכזי שאוכלים בליל הסדר בפסח?", options: ["חמץ", "מצה", "לחמנייה", "פסטה"], correct: 1 },
  ...
  { q: "איזה מכשיר אלקטרוני משמש אותנו לשיחות, משחקים וגלישה בדרכים?", options: ["מקרר", "טלפון חכם (סמארטפון)", "מיקרוגל", "מכונת כביסה"], correct: 1 },
  { q: "כמה שחקנים יש בקבוצת בייסבול על המגרש מטעם קבוצה אחת?", options: ["7", "9", "11", "5"], correct: 1 },
  ...
  { q: "מהי בירת גרמניה?", options: ["מינכן", "פרנקפורט", "ברלין", "הבורג"], correct: 2 },
  ...
  { q: "מהי בירת איטליה פעם נוספת כדי לוודא שאתם זוכרים?", options: ["מילאנו", "רומא", "נאפולי", "ונציה"], correct: 1 },
  { q: "איזה משחק קלפים כולל קלפים בצבעים אדום, צהוב, ירוק וכחול וקלפי הפתעה כמו 'פלוס 4'?", options: ["טאקי", "פוקר", "רמי", "טאקי / אונו"], correct: 3 },
  { q: "איזה חג מציין את מתן תורה הר סיני?", options: ["פסח", "שבועות", "סוכות", "פורים"], correct: 1 },
  ...
  { q: "מה שמה של בירת צרפת פעם נוספת?", options: ["לונדון", "פריז", "רומא", "מדריד"], correct: 1 },
  ...
  { q: "איזה ספורט משחקים על קרח עם מקלות ודיסקית (פאק)?", options: ["כדורגל", "הוקי קרח", "כדורסל", "טניס שולחן"], correct: 1 },
  { q: "מהו שמו של הגיבור בסרטי 'צעצוע של סיפור' שהוא בוקר צעצוע?", options: ["באז שורתי", "שרי", "וודי (Woody)", "רקס"], correct: 2 },
  { q: "איזה חרק מפורסם מגלגל כדורי בוץ וזבל להנאתו?", options: ["פרת משה רבנו", "חיפושית הזבל", "דבורה", "צרעה"], correct: 1 },
  { q: "מהו שמה של המדינה הגדולה בעולם בשטחה?", options: ["ארצות הברית", "סין", "רוסיה", "קנדה"], correct: 2 },
  { q: "איזה חלק בצמח אחראי על קליטת מים מהאדמה?", options: ["העלים", "הפרחים", "השורשים", "הגזע"], correct: 2 },
  { q: "כמה חודשים יש בשנה עברית רגילה?", options: ["10", "12", "13", "6"], correct: 1 },
  ...
  { q: "איזה משחק מחשב כולל דמות צהובה שאוכלת נקודות ונרדפת על ידי רוחות רפאים?", options: ["Pac-Man", "Tetris", "Mario", "Sonic"], correct: 0 },
  { q: "מהי בירת אוסטרליה (רמז: זו לא סידני)?", options: ["מלבורן", "קנברה", "בריזבן", "פרת'"], correct: 1 },
  { q: "איזה צבע מקבלים מערבוב של אדום וצהוב?", options: ["ירוק", "כתום", "סגול", "כחול"], correct: 1 },
  { q: "איזה חג יהודי מכונה 'חג האילנות'?", options: ["ט" בשבט", "פסח", "שבועות", "סוכות"], correct: 0 },
  { q: "מהו המאכל האהוב על הצב בנינג'ה טורטלס?", options: ["המבורגר", "פיצה", "סושי", "פסטה"], correct: 1 },
  { q: "איזה כוכב לכת ידוע בתור 'הכוכב האדום'?", options: ["נוגה", "מאדים", "צדק", "שבתאי"], correct: 1 },
  { q: "כמה רגליים יש לציפור טיפוסית?", options: ["2", "4", "6", "8"], correct: 0 },
  { q: "איזה מפורסם צייר את התקרה של הקפלה הסיסטינית ברומא?", options: ["לאונרדו דה וינצ'י", "מיכלאנג'לו", "רפאל", "וואן גוך"], correct: 1 },
  { q: "מהו כלי התחבורה המהיר ביותר שקיים כיום לטיסות נוסעים רגילות?", options: ["מסוק", "מטוס נוסעים רגיל", "רכבת מהירה", "רחפן"], correct: 1 },
  { q: "איזה בעל חיים הוא הנפוץ ביותר מבין חיות הבית (יחד עם חתולים)?", options: ["כלב", "תוכי", "ארנב", "אושר"], correct: 0 },
  { q: "מהי בירת טורקיה?", options: ["איסטנבול", "אנקרה", "אנטליה", "איזמיר"], correct: 1 },
  { q: "איזה פרי עגול ואדום נחשב בוטנית לירק לפעמים ויש לו גרעינים רבים מבפנים?", options: ["תפוח", "עגבנייה", "תות", "מלפפון"], correct: 1 },
  { q: "מי כתב את סדרת הספרים 'פרסי ג'קסון והאולימפיים'?", options: ["ג'יי קיי רולינג", "ריק רייורדן", "סטפני מאייר", "ג'. ר. ר. טולקין"], correct: 1 },
  { q: "כמה שחקנים יש בסך הכל על המגרש במשחק כדורגל אמיתי (שתי הקבוצות יחד)?", options: ["11", "16", "22", "20"], correct: 2 },
  { q: "איזה אוקיינוס נמצא בין אמריקה לאירופה?", options: ["האוקיינוס השקט", "האוקיינוס האטלנטי", "האוקיינוס ההודי", "אוקיינוס הקרח הדרומי"], correct: 1 },
  { q: "מה שמו של המדען המפורסם עם השיער הפרוע והשפה הבולטת שפיתח את תורת היחסות?", options: ["ניוטון", "איינשטיין", "אדיסון", "דרווין"], correct: 1 },
  { q: "איזה חג מציין את נס פך השמן?", options: ["פורים", "חנוכה", "פסח", "סוכות"], correct: 1 },
  { q: "מהי בירת קנדה?", options: ["טורונטו", "ונקובר", "אוטווה", "מונטריאול"], correct: 2 },
  { q: "איזה חיה ידועה בכך שהיא ישנה תלויה הפוך מהתקרה?", options: ["קוף", "עטלף", "דוב", "חתול"], correct: 1 },
  { q: "כמה רגליים יש לתמנון?", options: ["6", "8", "10", "12"], correct: 1 },
  { q: "איזה פרי צומח על שיחים נמוכים והוא אדום עם גרעינים קטנים מבחוץ?", options: ["תות שדה", "תפוח", "בננה", "אבטיח"], correct: 0 },
  ...
  { q: "איזה יסוד כימי מסומן באותיות Au והוא יקר מאוד?", options: ["כסף", "זהב (Gold)", "נחושת", "ברזל"], correct: 1 },
  { q: "כמה ימים בשבוע יש?", options: ["5", "6", "7", "8"], correct: 2 },
  { q: "איזה בעל חיים ימי ידוע בזכות היכולת שלו ליצור פנינים בתוך הקונכייה?", options: ["צדפה", "כוכב ים", "תמנון", "דג זהב"], correct: 0 },
  { q: "מהו שמו של הכלב הנאמן של מיקי מאוס?", options: ["פלטו", "גופי", "סנופי", "بول"], correct: 0 },
  { q: "איזה מדינה נמצאת מדרום לישראל?", options: ["לבנון", "סוריה", "מצרים", "ירדן"], correct: 2 },
  { q: "מהו כוכב הלכת הקרוב ביותר לשמש?", options: ["נוגה", "מרקורי", "מאדים", "ארץ"], correct: 1 },
  { q: "איזה צבע מקבלים מערבוב של שחור ולבן?", options: ["אפור", "אדום", "חום", "ירוק"], correct: 0 },
  { q: "איזה חג כולל ישיבה בסוכה ואכילה בחוץ?", options: ["פסח", "סוכות", "שבועות", "פורים"], correct: 1 },
  { q: "מה שמה של בירת איטליה בפעם האחרונה כדי לנעול?", options: ["מילאנו", "רומא", "ונציה", "טורינו"], correct: 1 }
];

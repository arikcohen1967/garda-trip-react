...
// מאגר ענק ומקיף בדיוק עם מעל 300 שאלות טריויה כלליות לגילאי עד 16
const ROAD_TRIVIA_QUESTIONS = [
  ...
  { q: "איזה סרט מציג רובוטים ענקיים שיכול להפוך למכוניות (אופטימוס פריים וכד')?", options: ["רובוטריקים (Transformers)", "מהיר ועצבני", "מלחמת הכוכבים", "אווטאר"], correct: 0 },

  // 141-240: בירות עולם וגאוגרפיה
  ...
  { q: "מהו המבנה המפורסם בעיר אגרה שבהודו הנחשב לאחד מפלאי עולם?", options: ["הטאג' מאהל", "החומה הסינית", "הקולוסיאום", "מגדל אייפל"], correct: 0 },
  { q: "באיזו מדינה נמצאת העיר העתיקה פטרה?", options: ["מצרים", "ירדן", "סוריה", "עיראק"], correct: 1 },
  { q: "מהי בירת איטליה?", options: ["מילאנו", "רומא", "ונציה", "נאפולי"], correct: 1 },
  { q: "באיזו יבשת נמצאת מדינת קניה?", options: ["אסיה", "אפריקה", "אמריקה", "אירופה"], correct: 1 },
  { q: "איזה מדינה אירופאית ידועה בתעלות המים שלה ובאופניים הרבים שבה?", options: ["הולנד", "פורטוגל", "יוון", "שוויץ"], correct: 0 },
  ...
  // 241-325: היסטוריה, המצאות, ספורט וחידות מגניבות נוספות
  { q: "מי המציא את מנורת הלהט המסחרית הראשונה?", options: ["תומאס אדיסון", "אלברט איינשטיין", "ניקולאס טסלה", "אלכסנדר גרהם בל"], correct: 0 },
  { q: "באיזו מדינה הומצא משחק הכדורגל המודרני?", options: ["ברזיל", "אנגליה", "איטליה", "ארגנטינה"], correct: 1 },
  { q: "כמה שחקנים יש בסך הכל על מגרש כדורסל רגיל בזמן משחק של שתי קבוצות?", options: ["5", "10", "12", "8"], correct: 1 },
  { q: "איזה ענף ספורט משחקים עם כדור צהוב קטן ומחבטים על מגרש דשא ירוק או חימר שנקרא ווימבלדון?", options: ["טניס", "כדורגל", "כדורעף", "גולף"], correct: 0 },
  { q: "איזה מדינה זכתה בהרבה גביעי עולם בכדורגל ומפורסמת בזכות שחקנים כמו פלה ונאיימר?", options: ["ארגנטינה", "ברזיל", "גרמניה", "צרפת"], correct: 1 },
  { q: "מה שמו של המשחק שבו מזיזים פרשים, צריחים ומלכה על לוח משבצות במטרה לאכול את המלך?", options: ["שחמט", "דמקה", "מונופול", "שש בש"], correct: 0 },
  { q: "איזה יסוד כימי מסומן באותיות Au?", options: ["זהב", "כסף", "נחושת", "ברזל"], correct: 0 },
  { q: "מהו כוכב הלכת הקרוב ביותר לשמש?", options: ["מרקורי (חמה)", "נוגה", "מאדים", "ארץ"], correct: 0 },
  { q: "מהי בירת אוסטריה?", options: ["וינה", "זלצבורג", "ברלין", "בודפשט"], correct: 0 },
  { q: "מהי בירת הונגריה?", options: ["בודפשט", "וינה", "פראג", "וורשה"], correct: 0 },
  { q: "מהי בירת צ'כיה?", options: ["פראג", "בודפשט", "ברטיסלבה", "וינה"], correct: 0 },
  { q: "איזו עיר אירופאית מכונה 'עיר האורות'?", options: ["פריז", "לונדון", "רומא", "אמסטרדם"], correct: 0 },
  { q: "מה שמה של הדמויות הראשיות בסדרת המשחקים 'סופר מריו'?", options: ["מריו ולואיג'י", "סוניק וטיילס", "פוקימון", "קראש וקוקו"], correct: 0 },
  { q: "איזה חרק בונה קורים דביקים כדי לתפוס חרקים אחרים?", options: ["עכביש (שבמחלקה קרובה)", "דבורה", "פרפר", "נמלה"], correct: 0 },
  { q: "כמה רגליים יש לפרה או לסוס?", options: ["2", "4", "6", "8"], correct: 1 },
  { q: "מה שמה של הבובה המפורסמת ביותר בעולם שנוצרה על ידי חברת מאטל ב-1959?", options: ["ברבי", "בובת חרסינה", "ברה", "לוסי"], correct: 0 },
  { q: "איזה פרי נחשב כמזון העיקרי של דוב קואלה באוסטרליה?", options: ["עלי אקליפטוס", "בננות", "תפוחי אדמה", "דבש"], correct: 0 },
  { q: "מהי הציפור המהירה ביותר בעולם בריצה שאינה יכולה לעוף?", options: ["יען", "פינגווין", "פלמינגו", "תוכי"], correct: 0 },
  { q: "כמה שחקנים יש בקבוצת בייסבול שעל המגרש?", options: ["9", "11", "5", "7"], correct: 0 },
  { q: "איזה משחק מחשב מפורסם משחקים עם בלונים וקופים שמנסים להרוס אותם?", options: ["Bloons TD", "Minecraft", "FIFA", "Tetris"], correct: 0 }
];
